<template>
    <view class="m-input-view">
        <input :focus="focus_" :disabled="disabled_" :type="inputType" :value="value" :confirm-type="confirmType" :maxlength="maxlength" @input="onInput" class="m-input-input" :placeholder="placeholder"
